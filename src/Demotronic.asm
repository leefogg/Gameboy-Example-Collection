...
.Loop:
    ...
    ; This takes up the remaing time between HBlank and Mode3 - 70 cycles
    REPT 64
        NOP 
    ENDR
...
; 1440 bytes. Each byte is a SCY value to set each tile each scanline
AllScanlineData:
...
; The 10 byte SCY array to use for this scanline
